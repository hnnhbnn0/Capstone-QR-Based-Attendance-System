                ...
                if(password_verify($password, $hashed_password)){
                    ...
                    if($data['userlevel'] == 'Admin'){
                        ...
                        if($data['2FA'] == 'true'){
                            ...
                            $db->ExecuteQuery("UPDATE `accounts` SET `2FA` = 'false' WHERE `email` = '$email'");
                            ...
                            if($data['userlevel'] == 'Teacher'){
                                header("Location: ../faculty/scan-qr.php");
