...
//     $.ajax({
//         url:'../controller/admin/profile-display.php',
//         method:'POST',
//         data: {
...
$(function(){
    ...
    $("form#personal-info").submit(function(evt){   
        ...
        // if($('.view-birthgroup').val() != ''){
        //     $('.view-birthgroup').addClass('is-valid')
        //     $('.view-birthgroup').removeClass('is-invalid')
        //     count++;
        // }else{
        //     $('.view-birthgroup').addClass('is-invalid')
        //     $('.view-birthgroup').removeClass('is-valid')
        // }
        ...
        if(count == 4){
            ...
            $.ajax({
                url: '/controller/admin/profile-update.php',
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
            ...
            Swal.fire({
                title: 'Input Error!',
                html: 'You have ' + Math.abs(parseInt(count-4)) + ' missing inputs',
                icon: 'warning',
            })
            return false
        }
    ...
    $("form#account-info").submit(function(evt){   
        ...
        if(count == 2){
            ...
            Swal.fire({
                title: 'Input Error!',
                html: 'You have ' + Math.abs(parseInt(count-2)) + ' missing inputs',
                icon: 'warning',
            })
            return false
        }
