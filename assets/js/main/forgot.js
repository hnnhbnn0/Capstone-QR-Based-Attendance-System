$(function(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response == 'password-ok'){
                        ...
                        $('#invalid-username').text('Your account has been disabled by the administrator.');
                        ...
                        $('#input-username').addClass('is-invalid')
                        $('#input-username').removeClass('is-valid')
                        $('#invalid-username').text('Your email must be incorrect.');
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(checkForgotUser() && response == 1){
                    ...
                    $('#invalid-forgot-username').text('Your email does not exist, try again.');
    ...
    $("form#form-register-otp").submit(function(evt){
        ...
        // $('#input-otp').val($('#input-username').val())
...
function checkUsername(){
    ...
    if(validUsername && username == '' && username.length > 6){
        $('#input-username').addClass('is-invalid')
        $('#input-username').removeClass('is-valid')
        $('#invalid-username').text('Please enter your email.');
        return false;
        ...
        $('#input-username').addClass('is-invalid')
        $('#input-username').removeClass('is-valid')
        $('#invalid-username').text('Your email must be valid.');
        return false;
...
function checkForgotUser(){
    ...
    if(validUsername && username == '' && username.length < 6){
        $('#input-forgot-username').addClass('is-invalid')
        $('#input-forgot-username').removeClass('is-valid')
        $('#invalid-forgot-username').text('Please enter your email.');
        return false;
    }else if(validUsername && username != '' && username.length >= 6){
        ...
        $('#input-forgot-username').addClass('is-invalid')
        $('#input-forgot-username').removeClass('is-valid')
        $('#invalid-forgot-username').text('Your email must be greater than 6 characters.');
        return false;
    }else if(!validUsername){
        $('#input-forgot-username').addClass('is-invalid')
        $('#input-forgot-username').removeClass('is-valid')
        $('#invalid-forgot-username').text('Your email must be valid.');
        return false;
    }else{
        $('#input-forgot-username').addClass('is-invalid')
        $('#input-forgot-username').removeClass('is-valid')
